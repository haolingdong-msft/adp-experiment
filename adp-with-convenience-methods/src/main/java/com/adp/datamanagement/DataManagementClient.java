...
public final class DataManagementClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BinaryData> createDataStreamStorageWithResponse(
            String measurementId, String dataStreamId, RequestOptions requestOptions) {
        return this.client.createDataStreamStorageWithResponse(measurementId, dataStreamId, requestOptions).block();
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public StorageBase createDataStreamStorage(
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public StorageBase createDataStreamStorage(String measurementId, String dataStreamId) {
        // Generated convenience method for createDataStreamStorageWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return createDataStreamStorageWithResponse(measurementId, dataStreamId, requestOptions)
                .getValue()
