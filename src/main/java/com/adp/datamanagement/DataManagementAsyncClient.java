...
public final class DataManagementAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> createDataStreamStorageWithResponse(
            String measurementId, String dataStreamId, RequestOptions requestOptions) {
        return this.serviceClient.createDataStreamStorageWithResponseAsync(measurementId, dataStreamId, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StorageBase> createDataStreamStorage(
            String measurementId, String dataStreamId, StorageCreationParameters body) {
        // Generated convenience method for createDataStreamStorageWithResponse
        RequestOptions requestOptions = new RequestOptions();
        if (body != null) {
            requestOptions.setBody(BinaryData.fromObject(body));
        }
        return createDataStreamStorageWithResponse(measurementId, dataStreamId, requestOptions)
                .flatMap(FluxUtil::toMono)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StorageBase> createDataStreamStorage(String measurementId, String dataStreamId) {
        // Generated convenience method for createDataStreamStorageWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return createDataStreamStorageWithResponse(measurementId, dataStreamId, requestOptions)
                .flatMap(FluxUtil::toMono)
